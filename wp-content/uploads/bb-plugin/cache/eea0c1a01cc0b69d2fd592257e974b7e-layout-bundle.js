var wpAjaxUrl = 'https://guillotelectrical.ca/wp-admin/admin-ajax.php';var flBuilderUrl = 'https://guillotelectrical.ca/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'https://guillotelectrical.ca/wp-content/plugins/bb-plugin/',
		wpAjaxUrl : 'https://guillotelectrical.ca/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992,
				...
				$wrapper.on( 'click', '.fl-menu-mobile-toggle', function( e ){
					...
					if ( self.mobileFlyout ) {
						...
						if ( self.mobileBelowRow ) {
							...
							targetMenu = $( this ).closest( '.fl-men
